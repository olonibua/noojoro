    ...
    return (
      <div className="flex min-h-screen items-center justify-center t-bg-card">
        <div className="text-center">
          ...
          <p className="text-lg font-medium t-text-secondary">Loading inventory...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="mx-auto max-w-2xl px-4 py-3">
        <div className="flex flex-wrap gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="t-text-muted">Healthy</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="h-3 w-6 rounded bg-amber-500" />
            <span className="t-text-muted">&lt; 20% left</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="h-3 w-6 rounded bg-red-500" />
            <span className="t-text-muted">Depleted</span>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-4 py-2">
        {Object.entries(categories).map(([category, items]) => (
          <div key={category} className="mb-6">
            <h2 className="mb-3 text-lg font-bold t-text">{category}</h2>
                ...
                return (
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between">
                      <span className="text-base font-semibold t-text">
                        {item.name}
                      </span>
                      <span className="text-sm font-medium t-text-muted">
