...
export default function DashboardHome() {
  ...
  return (
    <div className="mx-auto max-w-3xl py-12">
      <h1 className="text-3xl font-bold text-gray-900">Welcome to No Ojoro</h1>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2">
        ...
        <button
          ...
          className="group flex flex-col items-start rounded-xl border border-gray-200 bg-white p-6 text-left shadow-sm transition-all hover:border-[#22C55E]/40 hover:shadow-md"
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#22C55E]/10">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-900 group-hover:text-[#22C55E]">
            Create Event
          </h3>
